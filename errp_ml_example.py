# -*- coding: utf-8 -*-
"""ErrP_ml_example.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hkR8P1cN7ZkNkAO_1ifwMXz2fzfgEQbR
"""
...
desired_features = ["alpha_bandpower", "beta_bandpower", "theta_bandpower", "delta_bandpower", "kurtosis", "skewness", "node_strength"]
features = np.stack([wrapper.compute_features(sample, 512.0, desired_features=desired_features) for sample in cleaned])
print(f"Shape of training set features: {features.shape}")
